...
local function main()
	...
	Explorer.SetupConnections = function()
		if snapshotMode then return end -- Don't connect if in snapshot mode
	...
	Explorer.DisconnectConnections = function()
	...
	Explorer.ToggleSnapshot = function()
		snapshotMode = not snapshotMode
		local snapshotBtn = toolBar.Snapshot
		
		if snapshotMode then
			-- Entering snapshot mode - disconnect updates
			Explorer.DisconnectConnections()
			snapshotBtn.Text = "📸 Snap"
			snapshotBtn.BackgroundColor3 = Color3.fromRGB(60, 120, 180)
		else
			-- Exiting snapshot mode - reconnect updates
			Explorer.SetupConnections()
			snapshotBtn.Text = "📸 Live"
			snapshotBtn.BackgroundColor3 = Color3.fromRGB(51, 51, 51)
		end
	end
...
return search]==]
	...
	Explorer.Init = function()
		...
		local explorerItems = create({
			...
			{11,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2,0.2,0.2),BorderSizePixel=0,Font=3,Name="Snapshot",Parent={2},Position=UDim2.new(1,-64,0,1),Size=UDim2.new(0,42,0,18),Text="📸 Live",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=12,}},
			{12,"UICorner",{CornerRadius=UDim.new(0,2),Parent={11},}},
			{13,"Frame",{BackgroundColor3=Color3.new(0.15686275064945,0.15686275064945,0.15686275064945),BorderSizePixel=0,Name="ScrollCorner",Parent={1},Position=UDim2.new(1,-16,1,-16),Size=UDim2.new(0,16,0,16),Visible=false,}},
			{14,"Frame",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClipsDescendants=true,Name="List",Parent={1},Position=UDim2.new(0,0,0,23),Size=UDim2.new(1,0,1,-23),}}
		})
		...
		toolBar.Snapshot.MouseButton1Click:Connect(function()
			Explorer.ToggleSnapshot()
		end)
